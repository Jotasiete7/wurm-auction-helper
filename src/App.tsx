  ...
  return (
    <div className="min-h-screen bg-wurm-bg font-sans text-wurm-text">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        <nav className="mb-6 flex gap-2 border-b border-wurm-border" aria-label={t('viewTabsLabel')}>
          <button
            type="button"
            onClick={() => setView('live')}
            className={`px-4 py-2 text-sm font-medium border-b-2 -mb-px transition-colors ${
              view === 'live'
                ? 'border-wurm-accent text-wurm-accent'
                : 'border-transparent text-wurm-muted hover:text-wurm-text'
            }`}
          >
            {t('viewLive')}
          </button>
